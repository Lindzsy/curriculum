...
- MDN docs
- getting feedback
  - node basics so they can have a REPL
  - functions to strings, reflective methods (eg Object.keys)
- Arrays, Strings, Numbers, Objects, true, false, undefined, null
- Property access
- Array access
- Closures / scope / local variables
  - redo linked list with toplevel functions + objects
- prototypical inheritance
  - redo linked list with a constructor / prototype
- The event loop and its implications (eg callbacks)
- Hoisting
*** Week 13 - Advanced JS, the web
- http://javascriptissexy.com/
- Understanding Events (probably do via jQuery b/c it's verbose)
- Understanding `this`
- namespacing and the global window object
- npm
- lodash, browserify, jQuery
- ajax
- in the asset pipeline
- using Rails as an API
*** Week 14 - Frontend
- Using data-id for a selector so that design selectors and js selectors don't conflict
